                ...
                <div class="row" style="height: 100vh;background-color: #172337;">
                    ...
                    <div class="col-8 midSection bg-white"
                        ...
                        <div class="row bottom-0 position-absolute" style="width: 66.6%; ">
                            <div class="col">
                                <img src="{{ url('assets/images/5th & 6th/35.png') }}" class="img-fluid "
                                style=" width:100%;height: 182px;" />
                            </div>
                            <div class="col">
                                <img src="{{ url('assets/images/5th & 6th/42.png') }}" class="img-fluid "
                                style=" width:100%;height: 182px;" />
                            </div>
                            <div class="col">
                                <img src="{{ url('assets/images/5th & 6th/43 - a.png') }}" class="img-fluid "
                                style=" width:100%;height: 182px;" />
                            </div>
                            <div class="col">
                                <img src="{{ url('assets/images/5th & 6th/43 - b.png') }}" class="img-fluid "
                                style=" width:100%;height: 182px;" />
                            </div>
                            <div class="col">
                                <img src="{{ url('assets/images/5th & 6th/43 - c.png') }}" class="img-fluid "
                                style=" width:100%;height: 182px;" />
                            </div>
                            <div class="col">
                                <img src="{{ url('assets/images/5th & 6th/45.png') }}" class="img-fluid "
                                style=" width:100%;height: 182px;" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 p-1" style="cursor: move;">
                                <div id="" ondrop="drop(event)" ondragover="allowDrop(event)">
                                    <img src="{{ url('assets/images/') }}kindergarten/1.png" draggable="true" ondragstart="drag(event)"
                                        id="drag2" style="height: 100%;width:100%">
                                </div>
                            </div>
                            <div class="col-12 p-1" style="cursor: move;">
                                <div id="" ondrop="drop(event)" ondragover="allowDrop(event)">
                                    <img src="{{ url('assets/images/') }}kindergarten/14.png" draggable="true" ondragstart="drag(event)"
                                        id="drag3" style="height: 100%;width:100%">
                                </div>
                            </div>
                            <div class="col-12 p-1" style="cursor: move;">
                                <div id="" ondrop="drop(event)" ondragover="allowDrop(event)">
                                    <img src="{{ url('assets/images/') }}kindergarten/2.png" draggable="true" ondragstart="drag(event)"
                                        id="drag4" style="height: 100%;width:100%">
                                </div>
                            </div>
                            <div class="col-12 p-1" style="cursor: move;">
                                <div id="" ondrop="drop(event)" ondragover="allowDrop(event)">
                                    <img src="{{ url('assets/images/') }}kindergarten/3.png" draggable="true" ondragstart="drag(event)"
