...
--
-- Host: localhost:3306
-- Generation Time: May 05, 2023 at 01:42 AM
...
CREATE TABLE `enquiries` (
  ...
  `board_quantity` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `dimension_id` bigint(20) UNSIGNED DEFAULT NULL,
  `status` enum('enquiry','checkout_approved','checkout_pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'enquiry'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
