...
Route::middleware(['webGuard'])->group(function() {
    ...
    Route::get('custom-boards',[UserController::class,'show_custom_board'])->name('show-custom-board');
    Route::get('show-my-drafts', [UserController::class, 'show_my_drafts'])->name('show-my-drafts');
    Route::get('50-reasons',[UserController::class,'show_50_reasons'])->name('show-50-reasons');
    Route::get('e-book',[UserController::class,'show_e_book'])->name('show-e-book');
    Route::get('payment',[UserController::class,'show_payment'])->name('show-payment');
    Route::get('about-us',[UserController::class,'show_about_us'])->name('show-about-us');
    Route::get('user-show-contact-us',[UserController::class,'show_contact_us'])->name('show-contact-us');
    ...
    // Contact-us
    Route::post('contact-us', [UserController::class, 'contact_us'])->name('contactus-post');

    // PAYMENT
    Route::post('pay', [PaypalController::class, 'pay'])->name('payment');
    Route::get('payment-success', [PaypalController::class, 'success'])->name('payment-success');
    Route::get('payment-cancel', [PaypalController::class, 'success'])->name('payment-cancel');
...
Route::middleware(['adminGuard'])->group(function () {
    ...
    Route::get('orders', [AdminController::class, 'show_orders'])->name('show-orders');
    Route::get('payments', [AdminController::class, 'show_payments'])->name('show-payments');
    Route::get('elements', [AdminController::class, 'show_elements'])->name('show-elements');
    Route::get('show-contact-us', [AdminController::class, 'show_contact_us'])->name('show-contact-us');
    ...
    Route::get('show-prices', [AdminController::class, 'show_prices'])->name('show-prices');
    Route::post('show-prices/edit', [AdminController::class, 'edit_prices'])->name('edit-price');
