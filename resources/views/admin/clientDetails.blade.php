            ...
            <div class="container">
                <div class="card" style="width: 65rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text font-weight-bold">Board Quantity&#160;:&#160;<span class="font-weight-normal">{{
                                $enquiry['board_quantity'] }}</span></p>
                        <p class="card-text font-weight-bold">Black Markers&#160;:&#160;<span class="font-weight-normal">{{
                            $enquiry['black_marker'] }}</span></p>
                        <p class="card-text font-weight-bold">Green Markers&#160;:&#160;<span class="font-weight-normal">{{
                            $enquiry['green_marker'] }}</span></p>
                        <p class="card-text font-weight-bold">Blue Markers&#160;:&#160;<span class="font-weight-normal">{{
                            $enquiry['blue_marker'] }}</span></p>
                        <p class="card-text font-weight-bold">Red Markers&#160;:&#160;<span class="font-weight-normal">{{
                            $enquiry['red_marker'] }}</span></p>
                    </div>
                </div>
            </div>
        </div>
