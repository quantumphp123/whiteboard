...
<body>
            ...
            <div class="col-10">
                <div class="row" style="height: 100vh;background-color: #172337;">
                    <div class="col-2 position-relative">
                        ...
                        @for ($i = 1; $i <= 2; $i++)
                                    <div class="col">
                                        <div id="{{ 'front_left_side_div_'.$i }}" style="overflow-y: scroll;height: 200px;width:100%; border: 1px solid #a8a8a8" ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert">
                    ...
                    <div class="col-8 midSection bg-white"
                        ...
                        @if ($line != null)
                        <input type="text" class="form-control" value="{{ ucwords($line['name']) }}" style="color: white;background-color: #076DA8" readonly="true"/>
                        @if ($line['name'] == 'letter wrinting lines')
                        <div class="line1 box">
                        ...
                        @else
                        <input type="text" class="form-control" value="No Line Selected" style="color: white;background-color: #076DA8" readonly="true"/>
                        @endif
                        ...
                        <div class="row bottom-0 position-absolute" style="width: 55.6%;">
                            @for ($i = 1; $i <= 4; $i++)
                                    <div class="col">
                                        <div id="{{ 'div_'.$i }}" style="overflow-y: scroll;height: 173px;width:100%; border: 1px solid #a8a8a8" ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert">
                                            @foreach ($positions as $position)
                    ...
                    <div class="col-2 position-relative">
                        ...
                        @for ($i = 1; $i <= 2; $i++)
                                    <div class="col">
                                        <div id="{{ 'front_right_side_div_'.$i }}" style="overflow-y: scroll;height: 200px;width:100%; border: 1px solid #a8a8a8" ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert">
                                            @foreach ($positions as $position)
    ...
    <div class="row">
                <div class="col-10">
                    ...
                    <input type="hidden" value="4" name="grade_id">
                    <div class="row" style="height: 100vh;background-color: #172337;">
                        <div class="col-2 position-relative">
                            <div class="position-relative">
                                <img src="{{url('assets/images/triangle.png')}}" class="img-fluid"
                                    style="transform: rotate(180deg);width:100%" />
                                {{-- <a href="{{ route('save-draft', '4') }}">
                                    <div class="btn btn-primary position-absolute m-lg-4 m-2 px-lg-3"
                                        style="z-index: 1;left:0;background-color: #7548fe;"><span
                                            class="fa fa-save"></span>&nbsp;&nbsp;Save</div>
                                </a> --}}
                            </div>
                            <div class="bottom-0 position-absolute d-flex flex-column align-items-center" style="width: 100%;">
                           <div class="col-sm-12">
                            {{-- Back Left Side Boxes for Elements --}}
                           @for ($i = 1; $i <= 2; $i++)
                                    <div class="col">
                                        <div id="{{ 'back_left_side_div_'.$i }}" style="overflow-y: scroll;height: 230px;width:100%; border: 1px solid #a8a8a8" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            @foreach ($positions as $position)
                                                @if ('back_left_side_div_'.$i == $position['position'])
                                                    <img src="{{ asset('public/storage/'.$position['name'])}}" draggable="true" ondragstart="drag(event)" id="{{ $position['element_id'] }}" style="height: 100%;width:100%">
                                                @endif
                                            @endforeach
                                        </div>
                    ...
                    @if ($back_line != null)
                    <div class="back-line-box mt-2">
                        <img src="{{ url('assets/images/'.$back_line['img_name']) }}" alt="whole-number"
                            style="width:100%;" />
                    </div>
                    <input type="text" class="form-control" value="{{ $back_line['name'] }}" style="color: white;background-color: #076DA8" readonly="true"/>
                    @else
                    <input type="text" class="form-control" value="No Line Selected" style="color: white;background-color: #076DA8" readonly="true"/>
                    @endif
                ...
                <div class="col-2 position-relative">
                    ...
                    <div class="bottom-0 position-absolute" style="width: 100%;">
                    <div class="col-sm-12">
                        {{-- Back Right Side Boxes for Elements --}}
                           @for ($i = 1; $i <= 2; $i++)
                                    <div class="col">
                                        <div id="{{ 'back_right_side_div_'.$i }}" style="overflow-y: scroll;height: 230px;width:100%; border: 1px solid #a8a8a8" ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert">
                                            @foreach ($positions as $position)
                                                @if ('back_right_side_div_'.$i == $position['position'])
                                                    <img src="{{ asset('public/storage/'.$position['name'])}}" draggable="true" ondragstart="drag(event)" id="{{ $position['element_id'] }}" style="height: 100%;width:100%">
                                                @endif
                                            @endforeach
                                        </div>
