                ...
                <div class="row" style="height: 100vh;background-color: #172337;">
                    ...
                    <div class="col-12 midSection bg-white"
                        ...
                        <div class="p-2 d-flex" style="top:0;position: sticky;background-color: #d0d0d0;">
                            ...
                            <i class="fa fa-paper-plane-o" aria-hidden="true"></i>&nbsp;&nbsp;Buy Now <input type="hidden" name="gradeId" value="3"> </div>

                        </div>
                        <div>
                            <img style="width:100% ;height:auto ;" src="{{ url('assets\images\boardImages\WB F.1 3rd.jpg') }}" /> 
                        </div>
                        <div>
                    <img style="width:100% ;height:auto ;" src="{{ url('assets\images\boardImages\WB 3rd B.1.jpg') }}" /> 
                </div>
