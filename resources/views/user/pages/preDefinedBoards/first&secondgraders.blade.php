                    ...
                    <div class="col-12 midSection bg-white"
                        ...
                        <div class="p-2 d-flex" style="top:0;position: sticky;background-color: #d0d0d0;">
                                ...
                                BackBoard&nbsp;<img style="height: 20px ;"
                                    src="https://img.icons8.com/material-outlined/24/FFFFFF/move-right.png" />
                                </div> -->
                                ...
                                <i class="fa fa-paper-plane-o" aria-hidden="true"></i>&nbsp;&nbsp;Buy Now <input type="hidden" name="gradeId" value="2"> </div>
                        ...
                        <div>
                            <img style="width:100% ;height:auto ;" src="{{ url('assets\images\boardImages\1and2-front.jpg') }}" /> 
                        </div>
                        <div>
                <img style="width:100% ;height:auto ;" src="{{ url('assets\images\boardImages\WB-B-1st.jpg') }}" /> 
            </div>
