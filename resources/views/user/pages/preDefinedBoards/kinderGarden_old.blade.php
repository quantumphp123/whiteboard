                ...
                <div class="row" style="height: 100vh;background-color: #172337;">
                    <div class="col-2 position-relative">
                        <div class="position-relative">
                            ...
                            {{-- <div class="btn btn-primary position-absolute m-lg-4 m-2 px-lg-3"
                                ...
                                <span class="fa fa-save"></span>&nbsp;&nbsp;Enquiry
                            </div> --}}
                        </div>
                    ...
                    <div class="col-8 midSection bg-white"
                        ...
                        <div class="row bottom-0 position-absolute" style="width: 66.6%;">
                            <div class="col">
                                <img src="{{ url('assets/images/kindergarten/1.png') }}" class="img-fluid "
                                    style=" width:100%; height: 182px" />
                            </div>
                            <div class="col">
                                <img src="{{ url('assets/images/kindergarten/2.png') }}" class="img-fluid "
                                    style=" width:100%; height: 182px" />
                            </div>
                            <div class="col">
                                <img src="{{ url('assets/images/kindergarten/3.png') }}" class="img-fluid "
                                    style=" width:100%; height: 182px" />
                            </div>
                            <div class="col">
                                <img src="{{ url('assets/images/kindergarten/14.png') }}" class="img-fluid "
                                    style=" width:100%; height: 182px" />
                            </div>
                        </div>
                    </div>
