...
<body>
    ...
    <section id="frontBoard">
        <div class="row">
            <div class="col-12">
                <div class="col-12 midSection bg-white" style="height: 100vh; overflow-y: scroll;overflow-x: hidden;">
                    <div class="p-2 d-flex" style="top:0;position: sticky;background-color: #d0d0d0;">
                        ...
                        <div class="btn rounded-pill text-white px-3 d-flex align-items-center"
                            style="z-index: 1;left:0;background-color: rgb(7,109,168); margin-left: auto;"
                            id="sendEnquiryBtn">
                            <i class="fa fa-paper-plane-o" aria-hidden="true"></i>&nbsp;&nbsp;Send Enquiry <input
                                type="hidden" name="gradeId" value="1">
                        </div>
                    </div>
    ...
    <section id="backBoard" style="display:none;">
        ...
        <div class="col-12 midSection bg-white" style="height: 100vh; overflow-y: scroll;">
            ...
            <div> <img style="width:100% ;height:auto" src="{{ 'assets/images/boardImages/preK-back.jpg' }}"
...
sendEnquiryBtn.addEventListener('click', (e)=> {
    ...
    sendEnquiryBtn.addEventListener('click', ()=> {
        ...
        let gradeId = 1
        let dimensionId = 1
        let url = location.origin + '/projects/whiteboard/enquiry-form/' + gradeId + '/' + dimensionId + '/' + type
