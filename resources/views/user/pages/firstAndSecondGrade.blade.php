    ...
    <form action="{{ route('save-draft') }}" method="post">
        ...
        <section id="frontBoard">
            <div class="row">
                <div class="col-10">
                    ...
                    <input type="hidden" value="2" name="grade_id">
                    <div class="row" style="height: 100vh;background-color: #172337;">
                        <div class="col-2 position-relative">
                            ...
                            <img src="{{url('assets/images/logo-4.png')}}" class="img-fluid mb-1" style="width: 96%;" />
                                @for ($i = 1; $i < 3; $i++)
                                <div id={{ "front_left_side_div_".$i }} class="d-flex justify-content-center align-items-center"
                                style="overflow-y: hidden;height: 200px;width:100%; border: 1px solid #a8a8a8"
                                ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert"></div>
                                @endfor
                        ...
                        <div class="row bottom-0 position-absolute" style="width: 55.6%;">
                            @for ($i = 1; $i < 5; $i++) <div class="col">
                                <div id="{{ 'div_'.$i }}" class="d-flex justify-content-center align-items-center"
                                    style="overflow-y: scroll;height: 173px;width:100%; border: 1px solid #a8a8a8; color: #a8a8a8;"
                                    ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert"></div>
                        </div>
                        @endfor
                        {{-- <div class="col">
                ...
                <div class="col-2 position-relative">
                    ...
                    <div class="bottom-0 position-absolute" style="width: 100%;">
                        @for ($i = 1; $i < 3; $i++)
                        <div id={{ "front_right_side_div_".$i }} class="d-flex justify-content-center align-items-center"
                        style="overflow-y: hidden;height: 200px;width:100%; border: 1px solid #a8a8a8"
                        ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert"></div>  
                        @endfor
        ...
        <div class="row">
                <div class="col-10">
                    ...
                    <div class="row" style="height: 100vh;background-color: #172337;">
                        <div class="col-2 position-relative">
                           ...
                           <div class="col-sm-12">
                                @for ($i = 1; $i < 3; $i++)
                                <div id="{{ 'back_left_side_div_'.$i }}" class="d-flex justify-content-center align-items-center"
                                style="overflow-y: hidden;height: 230px;width:100%; border: 1px solid #a8a8a8"
                                ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert"></div>
                                @endfor
                        </div>
                ...
                <div class="col-2 position-relative">
                    ...
                    <div class="bottom-0 position-absolute" style="width: 100%;">
                        @for ($i = 1; $i < 3; $i++)
                        <div id="{{ 'back_right_side_div_'.$i }}" class="d-flex justify-content-center align-items-center"
                        style="overflow-y: hidden;height: 230px;width:100%; border: 1px solid #a8a8a8"
                        ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert"></div>
                        @endfor
                    </div>
