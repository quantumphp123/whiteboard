                ...
                <div class="row" style="height: 100vh;background-color: #172337;">
                    ...
                    <div class="col-8 midSection bg-white"
                        ...
                        <div class="row bottom-0 position-absolute" style="width: 55.6%;">
                            @for ($i = 1; $i < 5; $i++)
                                <div class="col">
                                    <div id="{{ 'div_'.$i }}" class="d-flex justify-content-center align-items-center" style="overflow-y: scroll;height: 173px;width:100%; border: 1px solid #a8a8a8" ondrop="drop(event)"
            ...
            <div class="col-10">
                ...
                <div class="row" style="height: 100vh;background-color: #172337;">
                    <div class="col-2 position-relative">
                        ...
                        @for ($i = 1; $i < 3; $i++)
                        <div class="col">
                            <div id="{{ 'back_left_side_div_'.$i }}" class="d-flex justify-content-center align-items-center" style="overflow-y: scroll;height: 230px;width:100%; border: 1px solid #a8a8a8" ondrop="drop(event)"
                                ondragover="allowDrop(event)" data-placeholder="Slide to Insert"></div>
                        </div>
                        @endfor
                ...
                <div class="bg-dark" style="bottom: 0;position:sticky;width: 100%; height: 100px;margin-bottom:-25rem">
                    ...
                    <div class="col-2 position-relative">
                        ...
                        <div class="col">
                            @for ($i = 1; $i < 3; $i++)
                            <div class="col">
                                <div id="{{ 'back_right_side_div_'.$i }}" class="d-flex justify-content-center align-items-center" style="overflow-y: scroll;height: 230px;width:100%; border: 1px solid #a8a8a8" ondrop="drop(event)"
                                    ondragover="allowDrop(event)" data-placeholder="Slide to Insert"></div>
                            </div>
                            @endfor
