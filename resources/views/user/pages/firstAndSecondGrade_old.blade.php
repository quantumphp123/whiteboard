                    ...
                    <div class="row" style="height: 100vh;background-color: #172337;">
                        ...
                        <div class="row bottom-0 position-absolute" style="width: 55.6%;">
                            @for ($i = 1; $i < 5; $i++) <div class="col">
                                <div id="{{ 'div'.$i }}" class="d-flex justify-content-center align-items-center"
        ...
        <section id="backBoard" style="display:none;">
            <div class="row" style="height: 100vh;background-color: #172337;">
                <div class="col-2">
                    ...
                    <div class="col-sm-12">
                        @for ($i = 1; $i <= 2; $i++)
                        <div id="{{ 'left_side_div_'.$i }}" class="d-flex justify-content-center align-items-center"
                            ...
                            <div class="justify-content-center d-flex text-white" style="margin-top: 150px;">
                                <div class="">
                                    <div class="d-lg-flex text-center align-items-center mb-lg-2 mb-3">
                                        <div class="mx-lg-3 mx-1 bg-danger" style="height: 5px;width: 20px;"></div>
                                        Subract
                                    </div>
                                    <div class="d-lg-flex text-center align-items-center mb-lg-2 mb-3">
                                    ...
                                    <div class="d-lg-flex text-center align-items-center mb-lg-2 mb-3">
                                        <div class="mx-lg-3 mx-1 bg-danger" style="height: 5px;width: 20px;"></div>Take
                                        Away
                                    </div>
                                    <div class="d-lg-flex text-center align-items-center mb-lg-2 mb-3">
                ...
                <div class="col-2">
                    ...
                    <div class="bottom-0 position-absolute" style="width: 100%;">
                        @for ($i = 1; $i <= 2; $i++)
                        <div id="{{ 'right_side_div_'.$i }}" class="d-flex justify-content-center align-items-center"
                        style="overflow-y: hidden;height: 230px;width:100%; border: 1px solid #a8a8a8"
                        ondrop="drop(event)" ondragover="allowDrop(event)" data-placeholder="Slide to Insert"></div>
                        @endfor
                    </div>
                        ...
                        <div class="row" style="height: 65vh; overflow-y: scroll;">
                            <div class="justify-content-center d-flex">
                                <div class="text-center">
                                    <div style="color: rgb(12, 241, 12);"><i class="fa fa-plus fa-4x"></i></div>
                            ...
                            <div class="my-4 text-white justify-content-center d-flex">
                                <div>
                                    <div class="d-flex align-items-center mb-2">
                                        <div style="color: rgb(12, 241, 12);"><i class="fa fa-plus fa-lg px-2"></i>
                                        </div>Add
                                    </div>
                                    <div class="d-flex align-items-center mb-2">
                                        <div style="color: rgb(12, 241, 12);"><i class="fa fa-plus fa-lg px-2"></i>
